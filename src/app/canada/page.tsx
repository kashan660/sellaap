...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Sellaap Canada - Premium Firestick Setup Services",
    description: "Professional Firestick setup services in Canada. Get your Firestick configured for Canadian streaming services.",
    keywords: "firestick setup Canada, Canadian streaming, firestick configuration, Canada firestick",
  };
}

export default async function CanadaPage() {
  const products = await getProducts('canada');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 max-w-2xl text-xl text-muted-foreground mx-auto">
            Premium Firestick setup services for Canadian customers. Get your Firestick configured for Canadian streaming services.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-card border border-border rounded-lg p-8">
            <h2 className="text-2xl font-bold text-foreground mb-4">Canadian Streaming Services</h2>
            <p className="text-muted-foreground mb-6">
              Our Firestick setups are optimized for Canadian streaming platforms including CBC Gem, CTV, Global TV, and more.
            </p>
