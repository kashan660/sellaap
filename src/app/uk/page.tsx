...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Sellaap UK - Premium Firestick Setup Services",
    description: "Professional Firestick setup services in the UK. Get your Firestick configured for UK streaming services.",
    keywords: "firestick setup UK, UK streaming, firestick configuration, UK firestick",
  };
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 max-w-2xl text-xl text-muted-foreground mx-auto">
            Premium Firestick setup services for UK customers. Get your Firestick configured for UK streaming services.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-card border border-border rounded-lg p-8">
            <h2 className="text-2xl font-bold text-foreground mb-4">UK Streaming Services</h2>
            <p className="text-muted-foreground mb-6">
              Our Firestick setups are optimized for UK streaming platforms including BBC iPlayer, ITV Hub, All 4, and more.
            </p>
